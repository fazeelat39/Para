...
const Footer = () => {
  return (
    <footer className='bg-slate-200 min-h-[calc(50vh-50px)]  '>
     ...
     <p className='text-center font-bold font-serif'>Wattoo Aluminium And Glass</p>
  ...
  <div className='  items-center  absolute pl-96 '>
    ...
    <div>
      <h1>Email Id : </h1>
     <p className='text-red-600 hover:text-red-700  cursor-pointer group : hover:underline '>wattooglass@gmail.com</p>
     <p>Phone Number :</p>
     <p className='text-red-600 hover:text-red-700  cursor-pointer group : hover:underline' > 03025752585</p>
     <p className='text-red-600 hover:text-red-700  cursor-pointer group : hover:underline' > 03025752585</p>
     </div>
